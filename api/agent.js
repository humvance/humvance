...
const {
  ...
  parseAIJSON
} = require('./_diagnostic-core');
// Catalogue, confidence engine and JSON hardening live in ./_diagnostic-core
// so Phase 3 can reuse them without modifying this verified router.
